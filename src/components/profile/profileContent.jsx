   ...
   setChangePassword(!changePassword)
    ...
    return <div className="salam absolute bg-body-bg p-2 rounded-md w-profile-w h-profile-h top-75px">
      ...
      <ProfileModal isOpen={isModalOpen} >
        ...
        <button className='w-profile_input_btn bg-custom-red text-white rounded-md h-10 mt-3'>Yadda Saxla</button>
        <Link className="block  text-end underline font-poppin" onClick={handlePasswordState}>Şifrəni dəyiş</Link>
        </div>
