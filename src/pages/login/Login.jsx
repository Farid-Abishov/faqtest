  ...
  return (
    <>
      <div className="flex flex-row justify-center items-center my-4">
        <h1 className="text-4xl font-semibold text-header-black">FAQ Support</h1>
      ...
      <div className="shadow-custom-shadow flex flex-column justify-center items-center max-w-login-container-width max-h-login-container-height mx-auto rounded-2xl p-3">
        <div className="text-center w-entry-container-width my-40">
          <p className="font-semibold text-3xl uppercase my-4 font-entry-title">Giriş</p>
          <span className="text-custom-black">FAQ Support platformasına giriş</span>
          <LoginInput setUserData={setUserData} title="Elektron Poçt" type="email" />
          <LoginInput setUserData={setUserData} title="Şifrə" type="password" />
          <a href="#" className="underline block text-right mt-1">Şifrənizi unutduz?</a>
          <button
            onClick={loginHandle}
